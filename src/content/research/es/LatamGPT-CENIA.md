---
title: "Vinculación con el Proyecto LatamGPT CENIA"
...
# Tipo de proyecto
projectType: "Asociación y Colaboración"

# Aspectos destacados
highlights:
  - "Primera reunión oficial realizada con investigadores de CENIA para explorar oportunidades de colaboración"
  - "Alineación con la misión de LatamGPT de desarrollar modelos de lenguaje para América Latina"
  - "Intercambio de conocimientos sobre PLN multilingüe y desafíos lingüísticos regionales"
  - "Contribuciones potenciales a iniciativas de IA de código abierto latinoamericanas"
...
# Recursos
resources:
  - name: "Proyecto LatamGPT"
    description: "Iniciativa oficial LatamGPT de CENIA"
    url: "https://cenia.cl"
    type: "other"
  - name: "Investigación SIMG"
    description: "Trabajo de nuestro grupo en modelos de lenguaje"
    url: "https://simg-un.com/es/research"
    type: "other"
...
# Financiamiento
funding:
  - "Iniciativa de investigación colaborativa (sin financiamiento)"
---
...
- [x] Primera reunión de colaboración completada
...
- **Email**: Contáctanos en [sitio web de SIMG](https://simg-un.com/es/contact)
- **Actualizaciones**: Sigue nuestro progreso en [GitHub](https://github.com/SIMG-UN)
